...
def train_network(model, train_data, optimiser, P):
...
def train(model, train_data, max_hidden_neurons, P, D, T, lr):
    ...
    while(True):
        ...
        train_network(model, train_data, optimiser, P)
...
def main():
    ...
    # train the model
    train(casper_net, train_data, hidden_neurons, P, D, T, lr)
